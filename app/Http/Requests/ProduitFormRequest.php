...
class ProduitFormRequest extends FormRequest
{
    ...
    {
        return [
            'designation'=>'required|min:5|max:50|unique:produits,designation,'.$this->produit,//designation,'.$id permet de mettre une exception pour pouvoir modifier le produit
